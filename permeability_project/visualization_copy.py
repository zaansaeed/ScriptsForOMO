...
def visualize_peptide_and_save_features(feature_map,pdb_file_of_template,feature_to_examine):
    ...
    with open('./debugging/saved_modelfeatures_sorted.csv', 'w', newline='') as f:
...
def visualize(path_to_model,path_to_X,path_to_y,descriptor_funcs):
    ...
    # r1c1
    pdb_file = "./debugging/template-1.pdb"
...
if __name__ == "__main__":
    ...
    path_to_x = "./debugging/saved_model/X_copy.csv"
    path_to_y = "./debugging/saved_model/Y_copy.csv"
    path_to_model = "./debugging/saved_model/random_forest_model.joblib"
    visualize(path_to_model,path_to_x, path_to_y, descriptor_funcs)
...
import py3Dmol
import ScriptsForOMO.functions as funcs
import tempfile
import webbrowser
import os
import re
...
def visualize(path_to_model,path_to_X,path_to_y,descriptor_funcs):
   ...
   # _, _, feature_ranges = analyze_feature_ranges(model, X)
    ...
    # r1c1
    pdb_file = "/Users/zaansaeed/PycharmProjects/pythonProject/ScriptsForOMO/debugging/template-1.pdb"
    feature_map = generate_feature_map("hydrogen", "oxygen", feature_blocks, {},descriptor_funcs)
    print(feature_map)
    visualize_peptide_and_save_features(feature_map, pdb_file, "Feature_1_side_chain_1_property_MolLogP")
...
if __name__ == "__main__":
    ...
    visualize("/Users/zaansaeed/PycharmProjects/pythonProject/ScriptsForOMO/debugging/saved_model/random_forest_model.joblib", "/Users/zaansaeed/PycharmProjects/pythonProject/ScriptsForOMO/debugging/saved_model/X_copy.csv", "/Users/zaansaeed/PycharmProjects/pythonProject/ScriptsForOMO/debugging/saved_model/y_copy.csv", descriptor_funcs)